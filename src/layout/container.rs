...
impl<'view, Subview> Container<'view, Subview> {
    ...
    pub fn with_padding_left(&mut self, padding_left: impl Into<ContainerPadding>) -> &mut Self {
        self.padding_left = padding_left.into();
        self
    }

    pub fn with_padding_right(&mut self, padding_right: impl Into<ContainerPadding>) -> &mut Self {
        self.padding_right = padding_right.into();
        self
    }

    pub fn with_padding_top(&mut self, padding_top: impl Into<ContainerPadding>) -> &mut Self {
        self.padding_top = padding_top.into();
        self
    }

    pub fn with_padding_bottom(
        &mut self,
        padding_bottom: impl Into<ContainerPadding>,
    ) -> &mut Self {
        self.padding_bottom = padding_bottom.into();
        self
    }

    pub fn with_padding(&mut self, padding: impl Into<ContainerPadding>) -> &mut Self {
        let padding = padding.into();
        self.with_padding_left(padding);
        self.with_padding_right(padding);
        self.with_padding_top(padding);
        self.with_padding_bottom(padding);
        self
    }

    pub fn with_spread_ratio_horizontal(&mut self, spread_ratio_horizontal: f32) -> &mut Self {
        self.spread_ratio_horizontal = spread_ratio_horizontal;
        self
    }

    pub fn with_spread_ratio_vertical(&mut self, spread_ratio_vertical: f32) -> &mut Self {
    ...
    Subview: View<'cx, UiState>,
{
    fn preferred_size(&mut self) -> RectSize<f32> {
        let subview_size = self.subview_size;
